...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh--budget--pot-0d8a70)](https://baditaflorin.github.io/mesh-budget-pot/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-budget-pot/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> A browser-local shared contribution pot.

**Live → https://baditaflorin.github.io/mesh-budget-pot/**

**Source → https://github.com/baditaflorin/mesh-budget-pot**
...
git clone https://github.com/baditaflorin/mesh-budget-pot
cd mesh-budget-pot
npm install
npm run dev
```
...
- `mesh-budget-pot:signalingUrl`
- `mesh-budget-pot:turnTokenUrl`
- `mesh-budget-pot:iceServers`
- `mesh-budget-pot:room`
